...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active"><spring:message code="stu.title.add"/></li>
    </ul>
</div>
<br><br>
<div class="container">
    ...
    <div id="user-profile-1" class="user-profile row">
        ...
        <div class="col-sm-9">
            <form class="form-horizontal layui-form" role="form"
                  action="${pageContext.servletContext.contextPath}/stu/add.do" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="stuNum" id="stuNum" class="col-xs-10 col-sm-5"
                               placeholder="请输入学号" lay-verify="stuNum">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="stuName" id="stuName" class="col-xs-10 col-sm-5"
                               placeholder="请输入姓名" lay-verify="stuName">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="lession" value="0" id="lession" class="col-xs-10 col-sm-5"
                               placeholder="请输入选修科目数" readonly lay-verify="lession">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select id="clazz" name="clazz.id" class="multiselect" lay-verify="required">
