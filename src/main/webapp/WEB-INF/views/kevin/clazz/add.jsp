...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active"><spring:message code="clazz.title.add"/></li>
    </ul>
</div>
<br><br>
<div class="container">
    <div id="user-profile-1" class="user-profile row">
        ...
        <div class="col-sm-9">
            <form class="form-horizontal layui-form" role="form" id="clazzForm"
                  action="${pageContext.servletContext.contextPath}/clazz/add.do" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="clazzName" id="clazzName" placeholder="请输入班级名称"
                               class="col-xs-10 col-sm-5" lay-verify="clazzName">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="perNum" id="perNum" class="col-xs-10 col-sm-5"
                               placeholder="请输入人数" value="0" readonly>
                    </div>
                </div>
