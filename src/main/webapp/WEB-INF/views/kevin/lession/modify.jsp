...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active"><spring:message code="clazz.title.edit"/></li>
    </ul>
</div>
<br><br>
<div class="container">
    <div id="user-profile-1" class="user-profile row">
        ...
        <div class="col-sm-9">
            <form class="form-horizontal layui-form" role="form" id="clazzForm"
                  action="${pageContext.servletContext.contextPath}/lession/modify.do" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="subName" id="subName" placeholder="请输入课程名称"
                               class="col-xs-10 col-sm-5" value="${lession.subName}" lay-verify="subName">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="score" id="score" class="col-xs-10 col-sm-5"
                               placeholder="请输入平均分" value="${lession.score}" readonly>
                    </div>
                </div>
